  ...
  return (
    <>
      <button
        ...
        className="w-[283px] border-2 items-center justify-center h-[56px] border-black flex self-center relative px-3 hover:bg-black hover:text-white transition-all ease-in-out duration-100"
      >
